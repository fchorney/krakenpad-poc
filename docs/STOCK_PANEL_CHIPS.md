...
| 1 (exact ref not noted) | small SMD | `7A` / TI logo / `M5P` | **Unidentified** TI part — topmark not decoded | Unknown; candidates worth checking: reset supervisor, small regulator, or logic |
...
(SW1, panel ID), 8-pin header (J1, presumed ISP programming for the AVR), RJ-style
...
5. **Precedents that validate our choices:** screw terminal for the per-panel

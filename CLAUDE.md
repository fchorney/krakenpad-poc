...
| INT (master) | 9–10 pos terminal block, pluggable (Euroblock) preferred | 9 conductors | — | One position per panel (+ spare). Replaced the 10-pin Micro-Fit + shared-GND idea — a lone GND pin had nowhere sensible to land across 9 discrete wires. Label both ends (slot mapping feeds panel-ID mismatch detection) |

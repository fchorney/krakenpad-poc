...
Every conductor in the pad, by harness. Colors are load-bearing during
reassembly — on the AC side getting one wrong is a safety failure, not a bug.

Status column: **confirmed** = observed at the 2026-08-08 teardown.
**TODO** = not yet recorded; ask before assuming.
...
| Conductor | Gauge | Color | Code | Status |
|-----------|-------|-------|------|--------|
| S1 | 28 AWG | red | `RD` | **TODO confirm** |
| S2 | 28 AWG | black | `BK` | **TODO confirm** |
...
| Conductor | Gauge | Color | Code | Status |
|-----------|-------|-------|------|--------|
| 12V | 22 AWG | yellow | `YE` | **TODO confirm** — from the Gen4+ manual, not observed |
| DATA | 22 AWG | pink | `PK` | **TODO confirm** — from the Gen4+ manual, not observed |
| GND | 22 AWG | black | `BK` | **TODO confirm** — from the Gen4+ manual, not observed |

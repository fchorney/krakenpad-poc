...
Connectors, contacts and cable used by the harnesses in this directory.
Board-side parts are already in the PCB BOMs (`docs/BOM.md`); this file covers
the **cable-side** halves and the wire itself, which no PCB BOM captures.
...
|-----|------|------|---------|
| Master J1 | Micro-Fit 3.0 3-pin, right angle | TODO | `rs485-chain.yml` |
| Master J2 | KF301-style 2-pos screw terminal, 5.08mm | TODO | `underglow.yml` |
...
| Carrier J210–J213 | Micro-Fit 3.0 power/RS-485 in/out | **UNSOURCED** | power / RS-485 |

`J210–J213` and the brain's `J301–J304` are still **order blockers** — see
`docs/PRE_ORDER_CHECKLIST.md`.
...
| **JST SMR-03V-B** (receptacle) **+ SM pin contacts** | underglow | **TODO SOURCE** | 1 |
| Micro-Fit 3.0 2-circuit receptacle housing (female terms) | 12V | TODO | 12 |
| Micro-Fit 3.0 3-circuit receptacle housing (female terms) | RS-485 | TODO | 18 |
| Micro-Fit 3.0 crimp terminals | 12V + RS-485 | TODO | ~78 |
| Fork/spade lugs, PSU stud size | 12V + GND ties | TODO | ~9 |
